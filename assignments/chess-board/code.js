...
drawText(WHITE_KNIGHT, width/1.275, height/10, 'black', 64);
drawText(WHITE_PAWN, width/1.87, height/4.5, 'black', 64);
drawText(WHITE_PAWN, width/2.5, height/4.5, 'black', 64);
drawText(WHITE_PAWN, width/1.1, height/4.5, 'black', 64);
drawText(WHITE_PAWN, width/30, height/4.5, 'black', 64);
drawText(WHITE_PAWN, width/1.52, height/4.5, 'black', 64);
...
drawText(BLACK_KNIGHT, width/1.275, height/1.04, 'black', 64);
drawText(BLACK_PAWN, width/1.87, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/2.5, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/30, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/1.1, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/3.5, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/1.52, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/6.2, height/1.2, 'black', 64); 
drawText(BLACK_PAWN, width/1.275, height/1.2, 'black', 64); 